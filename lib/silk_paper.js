...
const { fileTypes, DEFAULT_DOCS_DIR, DEFAULT_OPEN_API } = require('./constants');
...
module.exports = class SilkPaper {
   ...
   * @param {String} options.openApiVersion  - Desired open api version to generate the documentation.
   */
